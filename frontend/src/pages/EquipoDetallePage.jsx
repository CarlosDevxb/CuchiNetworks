...
const EquipoDetallePage = () => {
  ...
  const handleSave = async () => {
    try {
      ...
      dataToSend.append('posicion_fisica', formData.posicion_fisica);
      ...
      setEquipo({ 
          ...
          ubicacion_nombre: ubicacionSeleccionada?.nombre || equipo.ubicacion_nombre,
  ...
  // RENDERIZADORES
  const renderSpecs = () => {
      if (!equipo.detalles) return <p className="text-gray-400 text-sm italic">Sin especificaciones.</p>;
